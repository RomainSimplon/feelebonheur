...
class Suffice_Theme_Review_Notice {
	...
	public function review_notice_markup() {
		...
		<div class="notice notice-success suffice-notice theme-review-notice" style="position:relative;">
			...
			<div class="links">
				...
				<a href="?nag_suffice_ignore_theme_review_notice_partially=0" class="btn button-secondary">
					<span class="dashicons dashicons-calendar"></span>
					<span><?php esc_html_e( 'Maybe later', 'suffice' ); ?></span>
				</a>

				<a href="?nag_suffice_ignore_theme_review_notice=0" class="btn button-secondary">
			...
			<a class="notice-dismiss" href="?nag_suffice_ignore_theme_review_notice=0"></a>
	...
	public function ignore_theme_review_notice() {
		...
		if ( isset( $_GET['nag_suffice_ignore_theme_review_notice'] ) && '0' == $_GET['nag_suffice_ignore_theme_review_notice'] ) {
	...
	public function ignore_theme_review_notice_partially() {
		/* If user clicks to ignore the notice, add that to their user meta */
		if ( isset( $_GET['nag_suffice_ignore_theme_review_notice_partially'] ) && '0' == $_GET['nag_suffice_ignore_theme_review_notice_partially'] ) {
